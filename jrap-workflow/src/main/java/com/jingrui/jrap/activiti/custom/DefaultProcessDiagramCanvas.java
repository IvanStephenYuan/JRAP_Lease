...
public class DefaultProcessDiagramCanvas {
    ...
    protected static Color HIGHLIGHT_COLOR = new Color(173, 255, 47);//Color.GREEN;
    protected static Color HIGHLIGHT_COLOR_HIS = new Color(30, 144, 255);//Color.BLUE;
    ...
    // Strokes
    protected static Stroke THICK_TASK_BORDER_STROKE = new BasicStroke(1.0f);
    protected static Stroke GATEWAY_TYPE_STROKE = new BasicStroke(3.0f);
    protected static Stroke END_EVENT_STROKE = new BasicStroke(3.0f);
    protected static Stroke MULTI_INSTANCE_STROKE = new BasicStroke(1.3f);
    protected static Stroke EVENT_SUBPROCESS_STROKE = new BasicStroke(1.0f, BasicStroke.CAP_BUTT,
            BasicStroke.JOIN_MITER, 1.0f, new float[]{1.0f}, 0.0f);
    protected static Stroke NON_INTERRUPTING_EVENT_STROKE = new BasicStroke(1.0f, BasicStroke.CAP_BUTT,
    ...
    protected static Stroke ASSOCIATION_STROKE = new BasicStroke(2.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER,
    ...
    public void drawStartEvent(GraphicInfo graphicInfo, BufferedImage image, double scaleFactor) {
        ...
        if (graphicInfo instanceof NodeGraphicInfo && ((NodeGraphicInfo) graphicInfo).getColor() != null) {
            g.setPaint(((NodeGraphicInfo) graphicInfo).getColor());
        } else {
    ...
    public void drawConnection(int[] xPoints, int[] yPoints, boolean conditional, boolean isDefault,
        ...
        if (connectionType.equals("association")) {
            ...
            g.setPaint(HIGHLIGHT_COLOR_HIS);
    ...
    public void drawHighLightHis(int x, int y, int width, int height, FlowNode flowNode) {
     ...
     *
     * @param shape Bounds of this shape used to calculate parameters of inscribed
