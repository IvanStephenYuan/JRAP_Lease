	...
	*/
	...
	onHoverIn: function(event, instance, element){
	 ...
	 addHandlers: function(set, x, y, width, height, type){
	   ...
	   overlay.attr({stroke: Color.Orange,"stroke-width": 3, fill: Color.get(0,0,0), opacity: 0.0, cursor: "jingrui"});
...
// TODO: generate polylineId or do something!!
		...
		*/
		...
		var polyCloneAttrNormal = {"stroke-width": this.getStroke() + 5, stroke: Color.get(132,112,255), opacity: 0.0, cursor: "jingrui"};
