...
KISBPM.TOOLBAR = {
    ACTIONS: {
        ...
        collapsedPalette: function() {
            if (jQuery('#paletteHelpWrapper').is(":visible")) {
                jQuery('#paletteHelpWrapper').hide();
                if (jQuery('#propertiesHelpWrapper').is(":visible")) {
                    jQuery("#canvasHelpWrapper").attr("class", "col-xs-9 col-sm-9 col-md-9 col-lg-9");
                } else if (jQuery('#propertiesHelpWrapper').is(":hidden")) {
                    jQuery("#canvasHelpWrapper").attr("class", "col-xs-12 col-sm-12 col-md-12 col-lg-12");
                }
                return true;
            } else if (jQuery('#paletteHelpWrapper').is(":hidden")) {
                jQuery('#paletteHelpWrapper').show();
                if (jQuery('#propertiesHelpWrapper').is(":visible")) {
                    jQuery("#canvasHelpWrapper").attr("class", "col-xs-7 col-sm-7 col-md-7 col-lg-7");
                } else if (jQuery('#propertiesHelpWrapper').is(":hidden")) {
                    jQuery("#canvasHelpWrapper").attr("class", "col-xs-10 col-sm-10 col-md-10 col-lg-10");
                }
                return false;
            }
        },

        collapsedProperty: function() {
            if (jQuery('#propertiesHelpWrapper').is(":visible")) {
                jQuery('#propertiesHelpWrapper').hide();
                if (jQuery('#paletteHelpWrapper').is(":visible")) {
                    jQuery("#canvasHelpWrapper").attr("class", "col-xs-10 col-sm-10 col-md-10 col-lg-10");
                } else if (jQuery('#paletteHelpWrapper').is(":hidden")) {
                    jQuery("#canvasHelpWrapper").attr("class", "col-xs-12 col-sm-12 col-md-12 col-lg-12");
                ...
                jQuery('#propertiesHelpWrapper').show();
                if (jQuery('#paletteHelpWrapper').is(":visible")) {
                    jQuery("#canvasHelpWrapper").attr("class", "col-xs-7 col-sm-7 col-md-7 col-lg-7");
                } else if (jQuery('#paletteHelpWrapper').is(":hidden")) {
                    jQuery("#canvasHelpWrapper").attr("class", "col-xs-9 col-sm-9 col-md-9 col-lg-9");
        ...
        saveModel: function (services) {
            ...
            var modal = services.$modal({
                backdrop: true,
                keyboard: true,
                template: 'activiti-editor/popups/save-model.html?version=' + Date.now(),
        ...
        switchOldPage : function(services){
            var param = window.location.search;
            if(param){
                window.location.href = ACTIVITI.CONFIG.contextRoot+"/modeler.html"+ param;
            }
        },
        ...
        closeEditor: function(services) {
        	window.parent.close();
        	// window.parent.location.href = "../../jrap";
        },
