...
KISBPM.TOOLBAR_CONFIG = {
    "items" : [
        {
            "type" : "button",
            "title" : "TOOLBAR.ACTION.PALETTE.COLLAPSED",
            "cssClass" : "glyphicon glyphicon-indent-left",
            "action" : "KISBPM.TOOLBAR.ACTIONS.collapsedPalette"
        },
        {
            "type" : "separator",
            "title" : "",
        ...
        {
            "type" : "link",
            "text": "TOOLBAR.ACTION.SWITCH",
            "cssClass" : "",
            "action" : "KISBPM.TOOLBAR.ACTIONS.switchOldPage",
            "id" : "switch-button"
        }
    ],
    ...
    "secondaryItems" : [
        {
            "type" : "button",
            "title" : "TOOLBAR.ACTION.PROPERTY.COLLAPSED",
            "cssClass" : "glyphicon glyphicon-indent-right",
            "action" : "KISBPM.TOOLBAR.ACTIONS.collapsedProperty"
        },
        {
            "type": "separator",
            "title": "",
