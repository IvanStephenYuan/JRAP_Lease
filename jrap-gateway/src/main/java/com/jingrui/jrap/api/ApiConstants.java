...
public interface ApiConstants
{
     ...
     */
    String DEFAULT_TRANSFERDATA_MAAPPER = "com.jingrui.jrap.intergration.util.JrapTransferDataDefaultMapper";
