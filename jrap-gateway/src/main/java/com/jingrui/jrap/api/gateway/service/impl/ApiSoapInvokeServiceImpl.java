...
import com.jingrui.jrap.core.util.FreemarkerUtil;
...
public class ApiSoapInvokeServiceImpl implements IApiInvokeService, ProxySelf<IApiInvokeService> {
    ...
    private String translateSendXml(ApiServer server, JSONObject inbound) throws Exception {
        ...
        try {
            ...
            throw new JrapApiException(e.getMessage(), "Failed to generate the encoding, process variable fail");
        }
    ...
    private JSONObject translateReponseData(String data) throws Exception {
        ...
        try {
            ...
            logger.error(e.getMessage());
            throw new JrapApiException(JrapApiException.CODE_API_SYSTEM_EXCEPTION, JrapApiException.ERROR_XML_TO_MAP);
        }
        return jsonObject;
    }
    ...
    private String sendRequest(ApiServer server, String xml) throws Exception {
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() != ApiConstants.HTTP_RESPONSE_CODE_200) {
                throw new JrapApiException(JrapApiException.CODE_API_THIRD_REQUEST + "_" + response.getStatusLine().getStatusCode(), data);
            }
            return data;
        } catch (Exception e) {
            logger.error(e.getMessage(), e);
