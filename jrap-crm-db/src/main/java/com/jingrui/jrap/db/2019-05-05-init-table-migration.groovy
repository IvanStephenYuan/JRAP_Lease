...
databaseChangeLog(logicalFilePath:"2019-03-18-init-table-migration.groovy"){
 ...
 changeSet(author:"Admin", id: "2019-05-05_SYS_CODE_VALUE_V"){
    ...
    changeSet(author:"Admin", id: "2019-05-30_FND_COMPANY_SCORE"){
        if(mhi.isDbType('oracle') || mhi.isDbType('hana')){
            createSequence(sequenceName:'FND_COMPANY_SCORE_S', startValue:"10001")
        }
        createTable(tableName:"FND_COMPANY_SCORE"){
            column(name:"SCORE_ID",type:"bigint",autoIncrement:"true",startWith:"10001",remarks:"表ID，主键，供其他表做外键"){
                constraints(nullable:"false",primaryKey: "true",primaryKeyName: "FND_COMPANY_SCORE_PK")
            }
            column(name:"COMPANY_ID",type:"bigint",remarks:"商户ID")
            column(name:"SCORE_STANDARD",type:"varchar(200)",remarks:"评分标准")
            column(name:"SCORE_DETAIL",type:"varchar(200)",remarks:"评分明细")
            column(name:"SCORE",type:"decimal",remarks:"评分")
            column(name:"POINT",type:"decimal",remarks:"得分")
            column(name:"OBJECT_VERSION_NUMBER",type:"bigint",defaultValue:"1",remarks:"行版本号，用来处理锁"){
                constraints(nullable:"false")
            }
            column(name:"CREATED_BY",type:"bigint", defaultValue : "-1")
