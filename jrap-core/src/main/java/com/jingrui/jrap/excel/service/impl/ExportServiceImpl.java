...
public class ExportServiceImpl implements IExportService {
    ...
    private void exportExcel(String sqlId, ExportConfig gridInfo, IRequest iRequest, OutputStream outputStream, int rowMaxNumber)
            throws IOException {
    ...
    public void exportAndDownloadExcel(String sqlId, ExportConfig exportConfig, HttpServletRequest httpServletRequest,
        ...
        try (OutputStream outputStream = httpServletResponse.getOutputStream()) {
            exportExcel(sqlId, exportConfig, iRequest, outputStream, rowMaxNumber);
        }
    }
    ...
    public void exportAndDownloadExcel(String sqlId, ExportConfig exportConfig, HttpServletRequest httpServletRequest,
        ...
        exportAndDownloadExcel(sqlId, exportConfig, httpServletRequest, httpServletResponse, iRequest, 1000000);
    }
}
