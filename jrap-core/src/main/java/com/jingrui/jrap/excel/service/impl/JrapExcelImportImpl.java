...
/**
 * Created by jialong.zuo@jingrui.com on 2017/4/17.
 */
public class JrapExcelImportImpl extends DefaultHandler {
    ...
    public JrapExcelImportImpl(String tableName, SqlSession sqlSession) throws ExcelException {
