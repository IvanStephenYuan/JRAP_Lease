...
package com.jingrui.jrap.script.controllers;
...
/**
 * FOR TEST ONLY, DELETE IN THE FUTURE.
 * <p>
 * USED TO DETECT PROBLEMS ON REMOTE SERVER
 * 
 * @author jessen
 */
//@Controller
public class SpyController {
    ...
    public @ResponseBody String spy(HttpServletRequest request) throws Exception {
    ...
    @RequestMapping(value = "/common/spy/js", method = RequestMethod.POST,
            ...
            produces = "text/plain;charset=UTF-8")
    public @ResponseBody String spyJs(HttpServletRequest request) throws Exception {
        String js = null;
        try (InputStream is = request.getInputStream()) {
