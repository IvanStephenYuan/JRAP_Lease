...
import com.jingrui.jrap.audit.service.IAuditService;
import com.jingrui.jrap.audit.service.IAuditTableNameProvider;
import com.jingrui.jrap.audit.service.impl.DefaultAuditTableNameProvider;
import com.jingrui.jrap.core.ILanguageProvider;
import com.jingrui.jrap.core.IRequest;
import com.jingrui.jrap.core.ITlTableNameProvider;
import com.jingrui.jrap.core.annotation.AuditEnabled;
...
import static com.jingrui.jrap.system.dto.DTOClassInfo.getEntityFields;
 ...
 *         lijian.yin@jingrui.com
 */
@Intercepts({@Signature(type = Executor.class, method = "update", args = {MappedStatement.class, Object.class})})
public class AuditInterceptor implements Interceptor {

    private Logger logger = LoggerFactory.getLogger(com.jingrui.jrap.core.interceptor.AuditInterceptor.class);
    ...
    private void doAudit(BaseDTO dto, String type, MappedStatement mappedStatement, Object param) throws Exception {
        ...
        for (Map.Entry<String, EntityField> entry : getEntityFields(clazz).entrySet()) {
            // 修复审计时间问题
    ...
    private void loadService() {
        ...
        if (null == languageProvider) {
            languageProvider = beanFactory.getBean(ILanguageProvider.class);
        }
    }
