package com.jingrui.jrap.intergration.exception;
...
public class JrapApiException extends BaseException {
    ...
    /**
     * 服务注册异常处理
     * @author peng.jiang@jingrui.com on 2017/10/9
     */
    ...
    protected JrapApiException(String code, String descriptionKey, Object[] parameters) {
        super(code, descriptionKey, parameters);
    }

    public JrapApiException(String code, String descriptionKey){
