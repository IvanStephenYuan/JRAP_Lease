...
public class UpConstants {
     ...
     * 上传文件类型不正确.
     */
    public static final String ERROR_UPLOAD_FILE_TYPE_MISMATCH = "jrap.upload.file.type.mismatch";
    /**
     * 单个文件大小超出错误.
     */
    public static final String ERROR_UPLOAD_FILE_SIZE_ERROR = "jrap.upload.file.size.limit.exceeded";
    /**
     * 下载文件不存在.
     */
