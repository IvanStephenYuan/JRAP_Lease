package com.jingrui.jrap.security.crypto.encrypt;
...
public class AESEncryptors {
    ...
    public static void main(String[] args) {
        ...
        TextEncryptor textEncryptor = queryableText("myPassword", "abc12345", 128);
        String rawPassword = "123";
        String encodedPassword;
        encodedPassword = textEncryptor.encrypt(rawPassword);
        textEncryptor = queryableText("myPassword", "abc12345", 128);
