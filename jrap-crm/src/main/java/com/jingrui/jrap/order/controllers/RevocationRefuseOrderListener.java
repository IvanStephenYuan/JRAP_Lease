/*
 * *
 *  @file com.maddyhome.idea.copyright.pattern.JavaCopyrightVariablesProvider$1@6411dbef$
...
public class RevocationRefuseOrderListener implements ExecutionListener, IActivitiBean {
  ...
  public void notify(DelegateExecution delegateExecution) {
    ...
    orderServiceimp.updateOrderCheck("REFUSE", revocationId);
  }
