...
public interface ICompanyLimitService extends IBaseService<CompanyLimit>, ProxySelf<ICompanyLimitService> {
    ...
    ResponseData adjust(IRequest iRequest, CompanyLimit dto);

    void addCap(IRequest iRequest, CompanyLimit dto);

    ResponseData limitChangeApply(IRequest iRequest, List<CompanyLimit> dto);
}