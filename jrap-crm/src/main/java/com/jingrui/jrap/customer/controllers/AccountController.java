...
public class AccountController extends BaseController {
  ...
  @RequestMapping(value = "/afd/account/queryone")
  @ResponseBody
  public ResponseData queryone(Account dto, @RequestParam(defaultValue = DEFAULT_PAGE) int page,
      @RequestParam(defaultValue = DEFAULT_PAGE_SIZE) int pageSize, HttpServletRequest request) {
    IRequest requestContext = createRequestContext(request);
    return new ResponseData(service.select(requestContext, dto, page, pageSize));
  }
  ...
  @ResponseBody
  public ResponseData update(@RequestBody List<Account> dto, BindingResult result,
