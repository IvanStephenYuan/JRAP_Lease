...
INSERT INTO SYS_ATTACH_CATEGORY_B(CATEGORY_ID,CATEGORY_NAME,LEAF_FLAG,DESCRIPTION,STATUS,PARENT_CATEGORY_ID,PATH,SOURCE_TYPE,ALLOWED_FILE_TYPE,ALLOWED_FILE_SIZE,CATEGORY_PATH,IS_UNIQUE)VALUES(3,'目录3','0','null','1',2,'1.2.3',null,null,null,null,null);
INSERT INTO SYS_ATTACH_CATEGORY_B(CATEGORY_ID,CATEGORY_NAME,LEAF_FLAG,DESCRIPTION,STATUS,PARENT_CATEGORY_ID,PATH,SOURCE_TYPE,ALLOWED_FILE_TYPE,ALLOWED_FILE_SIZE,CATEGORY_PATH,IS_UNIQUE)VALUES(4,'Leaf 1','1','Leaf 1','1',3,'1.2.3.4','IMG','.jpg;.jpeg;.png',0,'/Users/jessen/Pictures/jrap/img','N');
