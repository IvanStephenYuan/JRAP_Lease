...
import com.jingrui.jrap.mail.PriorityLevelEnum;
import com.jingrui.jrap.mail.SendTypeEnum;
import com.jingrui.jrap.mail.dto.*;
import com.jingrui.jrap.mail.mapper.*;
...
public class MessageServiceImpl implements IMessageService {
    ...
    public Message addEmailMessage(Long userId, String accountCode, String templateCode, Map<String, Object> data,
        ...
        if (PRIORITY_VIP.equals(template.getPriorityLevel())) {
            messagePublisher.message("jrap:queue:email:vip", message);
        } else {
            messagePublisher.message("jrap:queue:email:normal", message);
        }
        return message;
    }
