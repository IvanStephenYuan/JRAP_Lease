...
@MultiLanguage
public class JrapInterfaceHeader extends BaseDTO implements AuthenticationAdapter{
    ...
    @Transient
    @Children
    private List<JrapInterfaceLine> lineList;
    ...
    public List<JrapInterfaceLine> getLineList() {
        return lineList;
    }

    public void setLineList(List<JrapInterfaceLine> lineList) {
