...
@Service
public class JrapPLSQLApiServiceImpl implements IJrapApiService {
  @Autowired
  private JrapJDBCSqlSessionFactory hapSqlSessionFactory;
  private Logger logger = LoggerFactory.getLogger(JrapPLSQLApiServiceImpl.class);

  @Override
  public JSONObject invoke(JrapInterfaceHeader headerAndLineDTO, JSONObject inbound) {
